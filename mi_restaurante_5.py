...
# Función para verificar si el usuario ya está registrado y permitir el inicio de sesión
...
def iniciar_programa():
    ...
    if not usuario_existente:
        ...
        datos_usuario = solicitar_datos()
        guardar_usuario_en_csv(datos_usuario)
        print("\nUsuario creado con éxito. Iniciando el programa...\n")
    else:
        print("\nIniciando sesión...\n")

    # Después de iniciar sesión correctamente, permitir agregar más usuarios
    while True:
        agregar = input("¿Desea agregar un nuevo usuario? (S/N): ").strip().lower()
        if agregar == 's':
            ...
            print("Opción no válida. Elija S o N.")
